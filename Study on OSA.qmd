...
## **Question 1: Study based on risk factors for obstructive sleep apnoea (OSA)**
...
### **1.b Fitting The Regression Model**
...
### **1.c) F-test For The Overall Regression**
...
### **1.d) Model Validation & Appropriation**
...
### **1.g) Changes in** $R^2$ & adjusted $R^2$
